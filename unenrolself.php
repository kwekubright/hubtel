...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'hubtel'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/hubtel/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_hubtel', format_string($course->fullname));
