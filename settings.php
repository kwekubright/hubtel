...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_heading('enrol_hubtel_defaults',
        get_string('enrolinstancedefaults', 'admin'), get_string('enrolinstancedefaults_desc', 'admin')));

    $options = array(ENROL_INSTANCE_ENABLED  => get_string('yes'),
                     ENROL_INSTANCE_DISABLED => get_string('no'));
    $settings->add(new admin_setting_configselect('enrol_hubtel/status',
        get_string('status', 'enrol_hubtel'), get_string('status_desc', 'enrol_hubtel'), ENROL_INSTANCE_DISABLED, $options));
    ...
    if (!during_initial_install()) {
        ...
        $settings->add(new admin_setting_configselect('enrol_hubtel/roleid',
            get_string('defaultrole', 'enrol_hubtel'), get_string('defaultrole_desc', 'enrol_hubtel'), $student->id, $options));
    }

    $settings->add(new admin_setting_configduration('enrol_hubtel/enrolperiod',
        get_string('enrolperiod', 'enrol_hubtel'), get_string('enrolperiod_desc', 'enrol_hubtel'), 0));
}
